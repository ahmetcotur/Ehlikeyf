<div>
    ...
    <div class="gsap-hero-parallax relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 text-center px-4 max-w-6xl mx-auto pt-28">
            ...
            <div class="gsap-fade-in mt-7 flex flex-wrap justify-center gap-3 text-white/80">
                <a href="{{ App\Models\Setting::getValue('google_maps_link', 'https://maps.app.goo.gl/qaEZ8ucy3BTa4GGK6') }}" target="_blank" rel="noopener" class="premium-glass-panel w-10 h-10 rounded-full flex items-center justify-center hover:text-brand transition-colors" title="Google Maps">
                ...
                <a href="{{ App\Models\Setting::getValue('instagram_link', 'https://www.instagram.com/ehlikeyfmeyhanekas/') }}" target="_blank" rel="noopener" class="premium-glass-panel w-10 h-10 rounded-full flex items-center justify-center hover:text-brand transition-colors" title="Instagram">
