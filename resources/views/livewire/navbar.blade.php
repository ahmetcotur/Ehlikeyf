<nav x-data="{ mobileMenuOpen: false }"
    ...
    <div x-show="mobileMenuOpen"
        ...
        <div class="px-6 py-8 space-y-4 text-center flex flex-col uppercase tracking-[0.15em] text-sm font-medium">
            ...
            <div class="pt-6">
                 <a href="{{ LaravelLocalization::getLocalizedURL(app()->getLocale(), 'booking') }}" class="inline-block px-8 py-4 bg-brand text-brand-dark hover:bg-brand-light transition duration-300 w-full tracking-[0.2em] text-xs rounded-full font-bold">{{ __('RESERVATION') }}</a>
            </div>
        </div>
    </div>
</nav>
